...
import {ExampleScreen1, ExampleScreen2, ExampleScreen3, MainScreen} from "@src/screens";
import {RNFC} from "@src/types";
import React from "react";

import {navigationRef} from "./navigationRef";
import {DefaultScreensParams, TRootStack} from "./params";
import {EXAMPLE_SCREENS, MAIN_SCREEN, onReady, onStateChange, screenOptions} from "./utils";
